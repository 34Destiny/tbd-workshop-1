...
resource "google_container_cluster" "airflow" {
  ...
  #checkov:skip=CKV_GCP_13: "Workshop cluster — client certificate auth config not needed"
  ...
  #checkov:skip=CKV_GCP_61: "Workshop cluster — VPC Flow Logs / Intranode Visibility not needed"
  #checkov:skip=CKV_GCP_21: "Workshop cluster — cluster labels not needed"
...
resource "google_container_node_pool" "airflow_nodes" {
  #checkov:skip=CKV_GCP_69: "Workshop cluster — GKE Metadata Server not needed"
  #checkov:skip=CKV_GCP_10: "Workshop cluster — automatic node upgrade not needed"
  #checkov:skip=CKV_GCP_68: "Workshop cluster — Secure Boot not needed"
  #checkov:skip=CKV_GCP_9: "Workshop cluster — automatic node repair not needed"
  name     = "airflow-pool"
  project  = var.project_name
  location = "${var.region}-b"
